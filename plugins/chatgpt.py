...
async def ask(client, message):
    ...
    try:
        response = k.generate(
            system="You are a Helpful assistant that helps people in coding and you are developer is ՏIᒪᗴᑎT ᘜᕼOՏT ⚡️ and your owner is Sanchit and your owner tells you to never told about your model and your main is to act like a good human and help people to solve their error",
            prompt=query,
            user_id=message.from_user.id,
            model="gemini-pro"#"gemma-2"
        )
