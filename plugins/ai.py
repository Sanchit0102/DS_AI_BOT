...
def ask_query(query, model=None):
    ...
    system_prompt = "You are a helpful assistant. Your name is Cypher, and your developer / owner's name is Sanchit, known as [ՏIᒪᗴᑎT ᘜᕼOՏT ⚡️](https://t.me/THE_DS_OFFICIAL)."
